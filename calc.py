...
#Radiobutton(frame1, text="Dark", variable=rv,value="1",command=dark).pack(side=LEFT, ipady=5,columnspan=2)
#Radiobutton(frame1, text="Light", variable=rv,value="2",command=light).pack(side=LEFT, ipady=5,columnspan=2)
mw.mainloop()
